...
{// TODO: Clean up names
 // TODO: Expand
	...
	/// </summary>
	public class MyGizmosBuffer : MonoBehaviour
	{
		#region Singleton
		private static MyGizmosBuffer instance;
		public static MyGizmosBuffer Instance
		{
			get
			{
				if (instance == null)
					instance = FindObjectOfType<MyGizmosBuffer>();
				return instance;
			}
		}
		void SingletonSetup()
		...
		{
			filledCircle2DBuffer.ForEach((b) => MyGizmos.DrawFilledCircle2D(
				b.origin,
				b.radius,
				b.totalPoints,
				b.color,
			...
			filledCircle2DBuffer_Static.ForEach((b) => MyGizmos.DrawFilledCircle2D(
				b.origin,
				b.radius,
				b.totalPoints,
				b.color,
